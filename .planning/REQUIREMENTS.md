...
- [x] **NOTF-03**: In-app notification badge for unread messages and new assignments
...
- [x] **UI-03**: Admin dashboard with at-a-glance view of upcoming jobs and resource status
